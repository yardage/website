...
const ui = {
  fr: {
    ...
    pricingExtras: [
      ...
      'Livraison sous 1 mois après validation du devis',
      'Minimum 150 exemplaires par commande',
      'Exemplaire numérique sur demande',
    ],
  ...
  en: {
    ...
    pricingExtras: [
      ...
      'Delivery within 1 month after quote approval',
      'Minimum 150 copies per order',
      'Digital sample on request',
    ],
